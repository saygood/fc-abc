...
from model.googlenet import Inception_new
...
parser.add_argument('--job_dir', type=str, default='./experiments/cifar/mobilenet_v2/bee_search_temp',
...
parser.add_argument('--lr', type=float, default=0.01, help='Learning rate for train. default:0.1')
parser.add_argument('--lr_decay_step', type=int, default=[150, 225], help='the iterval of learn rate decay. default:30')
parser.add_argument('--weight_decay', type=float, default=0.005, help='The weight decay of loss. default:1e-4')
...
# Beepruning
parser.add_argument('--honey_model', type=str, default='/mnt/pwork/ABCPruner/experiments/cifar/mobile_v2/training/checkpoint/model_best.pt',
...
parser.add_argument('--pr', type=float, default=0.9, help='pruning ratio of model')
...
parser.add_argument('--food_dimension', type=int, default=26,
...
parser.add_argument('--best_honey', type=int, nargs='+', default=[4, 8, 16, 15, 18, 5, 6, 1, 29, 8, 27, 25, 58, 36, 53, 86, 52, 94, 117, 47, 178, 182, 291, 288, 8, 256],
