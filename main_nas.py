...
def make_parser():
    ...
    parser.add_argument('--save', type=str, default='/home/yijiechen/workspace/DeepLearningExamples-master/PyTorch/Detection/SSD/save_models', help='save model checkpoints in the specified directory')
    ...
    parser.add_argument('--warmup', type=int, default=False)
    ...
    parser.add_argument('--backbone-path', type=str, default=None, help='Path to chekcpointed backbone. It should match the'
...
def train(train_loop_func, logger, args):
    ...
    # ssd300 = SNAS(backbone=ResNet(backbone=args.backbone, backbone_path=args.backbone_path, weights=args.torchvision_weights_version))
    ssd300 = SNAS(backbone=ResNet_NAS('resnet50_nas', honey=[8, 8, 8, 7, 7, 7, 7, 15, 12, 15, 13, 20, 14, 16, 12, 22, 16, 37, 33, 11, 27, 38, 14, 29, 13, 24, 21, 43, 65, 76, 30, 62, 49, 19, 75, 106, 320]))
